...
architecture by the specialization of an access control policy to be used for a particular PEP before deployment. The goal behind maintaining a single 
...
security mechanisms enforcing this policy at the business logic level. In such setting, when access control policies are updated or removed, 
