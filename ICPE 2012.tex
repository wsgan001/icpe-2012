...
\newcommand{\FixJeeHyun}[1]{{\large\textbf{}}\color{blue}{#1}\color{black}{}{\large\textbf{}}}
...
preserves policy behaviors (i.e., which responses are evaluated in terms of requests) of the subjects after refactoring, and (2) our approach is efficient in terms of reducing request evaluation time by up to nine times.
